...
### Runtime log evidence (from `~/Library/Application Support/DexDictate/debug.log`)
...
- `<repo-root>/Sources/DexDictateKit/TranscriptionEngine.swift`
- `<repo-root>/Sources/DexDictateKit/Services/AudioRecorderService.swift`
- `<repo-root>/Sources/DexDictateKit/Services/WhisperService.swift`
- `<repo-root>/Sources/DexDictateKit/InputMonitor.swift`
- `<repo-root>/Sources/DexDictateKit/AppSettings.swift`
- `<repo-root>/Sources/VerificationRunner/main.swift`
- `<repo-root>/docs/DexDictate_Strict_Experiment_Matrix.md`
