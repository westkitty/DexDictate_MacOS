...
public enum AudioFileImporter {
    ...
    public static func loadSamples(from url: URL) throws -> (samples: [Float], sampleRate: Double) {
        ...
        guard frameCount > 0 else { throw ImportError.noAudioData }
