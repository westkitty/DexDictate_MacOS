...
public final class WatermarkAssetProvider: ObservableObject {
    ...
    private static let standardRandomCycleFilenames: [String] = [
        ...
        "DexDictate_random_cycle__side_eye_pose__variant_a.png",
        "DexDictate_random_cycle__side_eye_pose__variant_b.png",
        "DexDictate_random_cycle__side_eye_pose__variant_c.png",
        "DexDictate_random_cycle__smiley_mask_splatter__variant_a.png",
        "DexDictate_random_cycle__smiley_mask_splatter__variant_b.png",
        "DexDictate_random_cycle__smiley_mask_splatter__variant_c.png",
        "DexDictate_random_cycle__standing_pose__variant_a.png",
        "DexDictate_random_cycle__standing_pose__variant_b.png",
        "DexDictate_random_cycle__standing_pose__variant_c.png",
